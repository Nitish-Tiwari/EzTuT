                                        ...
                                        <Row gutter={6}>
                                            <Col span={12} lg={12} md={12} sm={12} xs={24}>
                                                ...
                                                <div className='section_detail'>
                                                    ...
                                                    <h4>Phone Number : {studentData.email}</h4>
                                            ...
                                            <Col span={12} lg={12} md={12} sm={12} xs={24}>
                                                ...
                                                <div className='section_detail' >
                                                    <h4>Total Fee : {(studentData.fee).toLocaleString('hi-IN')}</h4>
                                                    <h4>Monthly Fee : {((studentData.fee) / 10).toLocaleString('hi-IN')}</h4>
                                                    <h4>Total Paid Fee : {(studentData.paidfee).toLocaleString('hi-IN')}</h4>
                                                    <h4>Remaining Fee : {(parseInt(studentData.fee) - parseInt(studentData.paidfee)).toLocaleString('hi-IN')}</h4>
                                                    <h4>Remianing Fee In Month: {(10 - (parseInt(studentData.paidfee) / (parseInt(studentData.fee) / 10))).toFixed(1)}</h4>
                                                </div>
